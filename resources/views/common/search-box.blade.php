<div class="search-box" data-list='{"valueNames":["title"]}'>
    ...
    <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
        <div class="scrollbar list py-3" style="max-height: 24rem;">
            ...
            <a class="dropdown-item px-x1 py-1 fs-9" href="#">
                <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <div class="file-thumbnail me-2">
                        <img class="border h-100 w-100 object-fit-cover rounded-3"
                            src="{{ Vitx::asset('assets/img/products/3-thumb.png') }}" alt="iPhone" />
                    </div>
                    <div class="flex-1">
            ...
            <a class="dropdown-item px-x1 py-2" href="#!">
                <div class="d-flex align-items-center">
                    <div class="file-thumbnail me-2">
                        <img class="img-fluid" src="{{ Vitx::asset('assets/img/icons/zip.png') }}" alt="Zip" />
                    </div>
                    <div class="flex-1">
            ...
            <a class="dropdown-item px-x1 py-2" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-l status-online me-2">
                        <img class="rounded-circle" src="{{ Vitx::asset('assets/img/team/1.jpg') }}" alt="Anna" />
                    </div>
                    <div class="flex-1">
            ...
            <a class="dropdown-item px-x1 py-2" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-l me-2">
                        <img class="rounded-circle" src="{{ Vitx::asset('assets/img/team/2.jpg') }}" alt="Antony" />
                    </div>
                    <div class="flex-1">
            ...
            <a class="dropdown-item px-x1 py-2" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-l me-2">
                        <img class="rounded-circle" src="{{ Vitx::asset('assets/img/team/3.jpg') }}" alt="Emma" />
                    </div>
                    <div class="flex-1">
