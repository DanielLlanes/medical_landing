    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="row gx-2">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight">
                        <span class="hover-overlay mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0"
                                src="{{ Vitx::asset('assets/img/generic/falcon-mode-default.jpg') }}"
                                alt="Light Mode" />
                        </span>
                ...
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark">
                        <span class="hover-overlay mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0"
                                src="{{ Vitx::asset('assets/img/generic/falcon-mode-dark.jpg') }}" alt="Dark Mode" />
                        </span>
                ...
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto">
                        <span class="hover-overlay mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0"
                                src="{{ Vitx::asset('assets/img/generic/falcon-mode-auto.jpg') }}" alt="Auto Mode" />
                        </span>
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start">
                <img class="me-2" src="{{ Vitx::asset('assets/img/icons/left-arrow-from-left.svg') }}" width="20"
                    alt="RTL" />
                <div class="flex-1">
                    <h5 class="fs-9">RTL Mode <span
                            class="badge rounded-pill badge-subtle-warning fs-11 ms-2">Next</span></h5>
                    <p class="fs-10 mb-0">Switch your language direction</p>
                    <a class="fs-10" href="#">RTL Documentation</a>
                </div>
            </div>
            <div class="form-check form-switch">
                <input class="form-check-input ms-0" id="mode-rtl" type="checkbox" disabled
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start">
                <img class="me-2" src="{{ Vitx::asset('assets/img/icons/arrows-h.svg') }}" width="20"
                    alt="Fluid" />
                <div class="flex-1">
                    <h5 class="fs-9">Fluid Layout</h5>
                    <p class="fs-10 mb-0">Toggle container layout system</p>
                    <a class="fs-10" href="#">Fluid Documentation</a>
                </div>
            </div>
            <div class="form-check form-switch">
        ...
        <div class="d-flex align-items-start">
            <img class="me-2" src="{{ Vitx::asset('assets/img/icons/paragraph.svg') }}" width="20"
                alt="Nav" />
            <div class="flex-1">
                <h5 class="fs-9 d-flex align-items-center">Navigation Position</h5>
                <p class="fs-10 mb-2">Select a suitable navigation system</p>
                <div>
        ...
        <div class="btn-group d-block w-100 btn-group-navbar-style mt-3">
            <div class="row gx-2">
                <div class="col-6 mb-2">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-transparent">
                        <img class="img-fluid img-prototype" src="{{ Vitx::asset('assets/img/generic/default.png') }}"
                            alt="" />
                ...
                <div class="col-6 mb-2">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-inverted">
                        <img class="img-fluid img-prototype"
                            src="{{ Vitx::asset('assets/img/generic/inverted.png') }}" alt="" />
        ...
        <div class="text-center mt-5">
            <img class="mb-4" src="{{ Vitx::asset('assets/img/icons/spot-illustrations/47.png') }}" alt=""
                width="120" />
            <h5>Like What You See?</h5>
            <p class="fs-10">Get Falcon now and create beautiful dashboards.</p>
            <a class="mb-3 btn btn-primary" href="#" target="_blank">Purchase</a>
        </div>
    </div>
</div>
